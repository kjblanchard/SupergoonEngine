    ...
    public class PlayerController : Controller, IUpdate
    {
        ...
        public override bool IsButtonPressed(ControllerButtons button)
        {
            return button switch
            {
                ...
                ControllerButtons.Up => _input.KeyPressed(_keyMapping.UpButton) || _input.KeyPressed(PlayerNum, _buttonMapping.UpButton),
                ControllerButtons.Right => _input.KeyPressed(_keyMapping.RightButton) || _input.KeyPressed(PlayerNum, _buttonMapping.RightButton),
                ControllerButtons.Down => _input.KeyPressed(_keyMapping.DownButton) || _input.KeyPressed(PlayerNum, _buttonMapping.DownButton),
                ControllerButtons.Left => _input.KeyPressed(_keyMapping.LeftButton) || _input.KeyPressed(PlayerNum, _buttonMapping.LeftButton),
                ControllerButtons.Y => _input.KeyPressed(_keyMapping.YButton) || _input.KeyPressed(PlayerNum, _buttonMapping.YButton),
                ControllerButtons.B => _input.KeyPressed(_keyMapping.BButton) || _input.KeyPressed(PlayerNum, _buttonMapping.BButton),
                ControllerButtons.A => _input.KeyPressed(_keyMapping.AButton) || _input.KeyPressed(PlayerNum, _buttonMapping.AButton),
                ControllerButtons.X => _input.KeyPressed(_keyMapping.XButton) || _input.KeyPressed(PlayerNum, _buttonMapping.XButton),
                ControllerButtons.Select => _input.KeyPressed(_keyMapping.SelectButton) || _input.KeyPressed(PlayerNum, _buttonMapping.SelectButton),
                ControllerButtons.Start => _input.KeyPressed(_keyMapping.StartButton) || _input.KeyPressed(PlayerNum, _buttonMapping.StartButton),
        ...
        public override bool IsButtonReleased(ControllerButtons button)
        {
            ...
            {
                ControllerButtons.Default => false,
                ControllerButtons.Up => _input.KeyReleased(_keyMapping.UpButton) || _input.KeyReleased(PlayerNum, _buttonMapping.UpButton),
                ControllerButtons.Right => _input.KeyReleased(_keyMapping.RightButton) || _input.KeyReleased(PlayerNum, _buttonMapping.RightButton),
                ControllerButtons.Down => _input.KeyReleased(_keyMapping.DownButton) || _input.KeyReleased(PlayerNum, _buttonMapping.DownButton),
                ControllerButtons.Left => _input.KeyReleased(_keyMapping.LeftButton) || _input.KeyReleased(PlayerNum, _buttonMapping.LeftButton),
                ControllerButtons.Y => _input.KeyReleased(_keyMapping.YButton) || _input.KeyReleased(PlayerNum, _buttonMapping.YButton),
                ControllerButtons.B => _input.KeyReleased(_keyMapping.BButton) || _input.KeyReleased(PlayerNum, _buttonMapping.BButton),
